...
| **Firebase / backend** | `firebase_core` ^4.10.0, `firebase_auth` ^6.5.2, `cloud_firestore` ^6.5.0, `cloud_functions` ^6.3.2, `firebase_storage` ^13.4.2, `firebase_analytics` ^12.4.2, `firebase_messaging` ^16.3.0, `firebase_database` ^12.4.2 |
| **Authentication** | `firebase_auth`, `google_sign_in` ^7.2.0, `google_sign_in_web` ^1.1.3 |
| **Serialization** | `json_annotation` ^4.12.0 (dev: `json_serializable` ^6.14.0, `build_runner` ^2.15.0) |
| **Networking** | `http` ^1.6.0, `connectivity_plus` ^7.1.1 |
| **Media** | `image_picker` ^1.2.2, `file_picker` ^11.0.2, `image` ^4.9.1, `video_player` ^2.11.1, `mime` ^2.0.0, `image_network` ^2.6.0 |
| **Maps & web views** | `google_maps_flutter` ^2.17.1, `webview_flutter` ^4.13.1, `webview_flutter_android` ^4.13.0, `webview_flutter_wkwebview` ^3.26.0, `universal_html` ^2.3.0, `pointer_interceptor` ^0.10.1+2 |
| **Localization & i18n** | `flutter_localizations`, `devicelocale` ^0.9.0, `intl` ^0.20.2, `dlibphonenumber` ^1.1.65 |
| **UI & content** | `google_fonts` ^8.1.0, `cupertino_icons` ^1.0.9, `omni_datetime_picker` ^2.3.2, `flutter_markdown_plus` ^1.0.7, `scrollable_positioned_list` ^0.3.8, `gap` ^3.0.1, `json_explorer` ^0.1.2 |
| **Utilities** | `package_info_plus` ^9.0.1, `url_launcher` ^6.3.2, `collection` ^1.19.1, `ansicolor` ^2.0.3 |
