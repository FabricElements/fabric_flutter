...
/// Pumps [child] with a loaded localization delegate so the picker's dropdown
/// resolves its bundled labels.
  ...
  group('CountryPicker', () {
    group('semantics forwarding', () {
      testWidgets('should forward the semanticsLabel to the input node', (
        ...
        // Arrange
        const label = 'Select your country';

        // Act
        await _pump(
          tester,
          CountryPicker(onChange: (_) {}, semanticsLabel: label),
        );
      ...
      testWidgets('should forward the automationKey as an identifier', (
        ...
        // Arrange
        const key = 'profile_address_input_country';

        // Act
        await _pump(
          tester,
          CountryPicker(onChange: (_) {}, automationKey: key),
        );
      ...
      testWidgets('should forward the semanticHint to the input node', (
        ...
        // Arrange
        const hint = 'Used to localize prices';

        // Act
        await _pump(
          tester,
          CountryPicker(onChange: (_) {}, semanticHint: hint),
        );
